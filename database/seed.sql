...
INSERT INTO servants VALUES
  ...
  (3, 'David Cameron', 'Not to be mistaken with James Cameron', '/david_cameron_profile.jpeg', 1000),
  ...
  (6, 'The Queen', 'She just loves to serve', '/queen_profile.webp', 2000),
  (7, 'Donald Trump', 'Urgh', '/donald_trump_profile.jpg', 0),
  ...
  (12, 'Cleopatra', 'Last but not least', '/cleopatra_profile.jpeg', 3000)
